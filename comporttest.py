...
class SerialMonitor(QtWidgets.QMainWindow):
    ...
    def portOpen(self, flag):
        if flag:
            ...
            r = self.port.open(QIODeviceBase.OpenModeFlag.ReadWrite)
            if not r:
...
class SerialDataView(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        self.serialData.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.serialDataHex.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
...
class SerialSendView(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        ...
        self.sendData.setSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)

        self.sendButton = QtWidgets.QPushButton('Send')
        self.sendButton.clicked.connect(self.sendButtonClicked)
        self.sendButton.setSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Preferred)
